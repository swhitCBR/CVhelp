#' @title Create a receiver detection interval data set based on ping-level detections
#' 
#' @description Reduce ping-level detection data to first and last time of detection per receiver level detection event
#'
